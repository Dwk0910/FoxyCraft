...
export default function Console({ serverUUID }) {
    ...
    return (
        <>
            <div className={"bg-[#2A2A2A] select-text font-mono w-full h-130 p-3 mb-2 rounded-[5px] border-2 border-gray-600 overflow-y-auto wrap-break-word"}>
                Console Log
            </div>
            <div className={"w-full flex flex-row items-center"}>
                <input type={"text"} className={"bg-[#2A2A2A] mb-3 w-full px-3 h-10 border-2 border-gray-600 rounded-[5px] font-mono outline-none"} placeholder={"Command Prompt Here"}/>
